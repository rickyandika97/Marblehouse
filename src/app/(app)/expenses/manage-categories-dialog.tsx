...
/**
 * The owner's category manager (§4.12, §8.8), folded into a modal reachable
 * from the Expenses screen instead of its own Settings page — there was
 * nothing else on that page, and every action it takes is scoped to expenses.
 *
